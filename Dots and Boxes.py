...
class DotsAndBoxes():
    ...
    def start(self):
        ...
        while self.gameOver() != False or self.quit == False:
            self.update()
        pygame.quit()
    ...
    def update(self):       
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self.isOnline != 'NA':
                    sendMessage(self.s,self.player2,'quit')
...
#As there are 25 possible boxes.
    def gameOver(self):
        ...
        #Quits the pygame and restores the main window. 
        if (self.playerOneScore + self.playerTwoScore == 25) or self.quit == True:
